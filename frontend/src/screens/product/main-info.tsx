            ...
            <div>
              ...
              <div className="flex gap-3.5 mt-1">
                {data.variations?.available_variations?.map((variation) => (
                  <a
                    key={variation.id}
                    href={process.env.DOMAIN_NAME + "/products/" + variation.id}
                    className={`font-medium p-3 border transition-all duration-200 rounded-[8px] relative ${
                    ...
                    {variation.in_stock || (
                      <span
                        style={{
                          ...
                          borderColor: "#E6E6E6",
                          transform:
                            "rotate(-27.5deg) scale(1.05) translate(0%, -50%)",
                          WebkitTransform:
                            "rotate(-27.5deg) scale(1.05) translate(0%, -50%)",
                          MozTransform:
                            "rotate(-27.5deg) scale(1.05) translate(0%, -50%)",
          ...
          {data.variations.current.quantity && (
            <div>
              <div className="flex gap-3.5 pt-3.5 items-center border-t">
                ...
                <p className="text-[#808080]">
                  {data.variations.current.quantity} шт
                </p>
              </div>
                ...
                {data.variations?.available_variations
                  ...
                  .map((variation) => (
                    <a
                      key={variation.id}
                      href={
                        process.env.DOMAIN_NAME + "/products/" + variation.id
                      }
                      className={`font-medium p-3 border transition-all duration-200 rounded-[8px] relative ${
                      ...
                      {variation.in_stock || (
                        <span
                          style={{
                            ...
                            borderColor: "#E6E6E6",
                            transform:
                              "rotate(-27.5deg) scale(1.1) translate(0%, -50%)",
                            WebkitTransform:
                              "rotate(-27.5deg) scale(1.1) translate(0%, -50%)",
                            MozTransform:
                              "rotate(-27.5deg) scale(1.1) translate(0%, -50%)",
